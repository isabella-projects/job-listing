...
class ListingController
{
    ...
    public function store()
    {
        ...
        $requiredFields = [
            'title', 'description', 'salary', 'email', 'city', 'state'
        ];
    ...
    public function update($params)
    {
        ...
        if (!isset($updateValues['salary']) || (!Validation::numeric($updateValues['salary']) && !empty($updateValues['salary']))) {
            $errors['salary'] = empty($updateValues['salary']) ? 'Salary is required' : 'Salary must be a number';
        }
